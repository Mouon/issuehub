...
<img width="950" alt="스크린샷 2024-05-05 오후 5 18 35" src="https://github.com/Mouon/issuehub/assets/137624597/dc6698df-7b40-4aa3-91a8-19a84a35d9fa">
...
사용자가 자주 조회하지만 내용의 변화가 적은 이슈상세나 리드미 상세에 대해서 캐싱을 하도록 하였습니다. 
캐싱만료 주기는 10분 리드미와 이슈 업데이트 주기는 6시간
이슈 리스트는 캐싱하기에는 대용량이기 떄문에 메모리에 캐싱하는 것은 위험하고 부적절하다고 판단하였습니다.
